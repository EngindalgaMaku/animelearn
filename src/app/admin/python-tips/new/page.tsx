...
export default function NewPythonTip() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/admin/python-tips", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        alert("Python tip created successfully!");
      ...
      alert("Failed to create Python tip");
    } finally {
      setLoading(false);
    }
  };
