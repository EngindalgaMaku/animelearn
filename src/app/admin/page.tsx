      ...
      setStats({
        ...
        recentActivities: [
          ...
          },
          {
            ...
            description: 'Weekly challenge "Python Basics" completed by 45 users',
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg font-medium text-gray-600">Loading admin panel...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-red-50 to-pink-50">
        <div className="text-center">
          ...
          <p className="text-lg font-medium text-gray-600 mb-4">Access Denied</p>
          <p className="text-sm text-gray-500 mb-4">Please log in with admin credentials</p>
          <Link
            href="/login"
  ...
  if (!isAdmin) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-red-50 to-pink-50">
        <div className="text-center">
          <Shield className="mx-auto h-16 w-16 text-red-500 mb-4" />
          <p className="text-lg font-medium text-gray-600 mb-4">Insufficient Permissions</p>
          <p className="text-sm text-gray-500 mb-4">You need admin access to view this panel</p>
          <Link
            href="/dashboard"
      ...
      <div className="relative z-10 py-6 lg:py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="rounded-2xl border border-white/60 bg-white/90 p-6 lg:p-8 shadow-xl backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-gray-900 via-red-800 to-purple-800 bg-clip-text text-transparent">
                      🛡️ Admin Panel
                    </h1>
          ...
          <div className="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-6 lg:gap-6">
            <div className="lg:col-span-1 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 p-6 text-white shadow-xl">
              <div className="mb-2 rounded-xl bg-white/20 p-2 w-fit">
            ...
            <div className="lg:col-span-1 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 p-6 text-white shadow-xl">
              <div className="mb-2 rounded-xl bg-white/20 p-2 w-fit">
            ...
            <div className="lg:col-span-1 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-600 p-6 text-white shadow-xl">
              <div className="mb-2 rounded-xl bg-white/20 p-2 w-fit">
            ...
            <div className="lg:col-span-1 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 p-6 text-white shadow-xl">
              <div className="mb-2 rounded-xl bg-white/20 p-2 w-fit">
            ...
            <div className="lg:col-span-1 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 p-6 text-white shadow-xl">
              <div className="mb-2 rounded-xl bg-white/20 p-2 w-fit">
            ...
            <div className="lg:col-span-1 rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 p-6 text-white shadow-xl">
              <div className="mb-2 rounded-xl bg-white/20 p-2 w-fit">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
              ...
              {/* Quiz Management */}
              <div className="group rounded-2xl border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:border-blue-400">
                <div className="mb-6 flex items-center">
                  <div className="rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 p-3 shadow-lg">
                    <BookOpen className="h-7 w-7 text-white" />
                  </div>
                  <h2 className="ml-4 text-xl font-bold text-gray-900">📝 Quiz Management</h2>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="ml-4 flex-1">
                      <p className="font-semibold text-gray-900">Manage Questions</p>
                      <p className="text-sm text-gray-600">Add, edit, delete quiz questions</p>
                    </div>
                  ...
                  >
                    ...
                    <div className="ml-4 flex-1">
                      ...
                      <p className="text-sm text-gray-600">Manage question categories</p>
                    </div>
              ...
              {/* User Management */}
              <div className="group rounded-2xl border-2 border-green-300 bg-gradient-to-br from-green-50 to-emerald-50 p-6 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:border-green-400">
                <div className="mb-6 flex items-center">
                  <div className="rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 p-3 shadow-lg">
                    <Users className="h-7 w-7 text-white" />
                  </div>
                  <h2 className="ml-4 text-xl font-bold text-gray-900">👥 User Management</h2>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="ml-4 flex-1">
                      <p className="font-semibold text-gray-900">Roles & Permissions</p>
              ...
              {/* System Settings */}
              <div className="group rounded-2xl border-2 border-orange-300 bg-gradient-to-br from-orange-50 to-red-50 p-6 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:border-orange-400">
                <div className="mb-6 flex items-center">
                  <div className="rounded-xl bg-gradient-to-r from-orange-500 to-red-500 p-3 shadow-lg">
                    <Settings className="h-7 w-7 text-white" />
                  </div>
                  <h2 className="ml-4 text-xl font-bold text-gray-900">⚙️ System Settings</h2>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center p-4 rounded-lg bg-green-50 border border-green-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-medium text-gray-900">Completed Quizzes</span>
                  </div>
