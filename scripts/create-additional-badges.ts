...
const additionalBadges = [
  ...
  },
  {
    ...
    rewardDiamonds: 200,
    rewardXp: 350,
    conditionType: "weekend_learning",
    condition: JSON.stringify({
  ...
  },
  {
    ...
    rewardDiamonds: 150,
    rewardXp: 250,
    conditionType: "morning_learning",
    condition: JSON.stringify({
  ...
  },
  {
    ...
    rewardDiamonds: 400,
    rewardXp: 600,
    conditionType: "creative_solutions",
    condition: JSON.stringify({
  ...
  },
  {
    ...
    rewardDiamonds: 400,
    rewardXp: 500,
    conditionType: "successful_trades",
    condition: JSON.stringify({
