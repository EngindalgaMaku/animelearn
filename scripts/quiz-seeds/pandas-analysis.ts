...
export const pandasAnalysisCategories: QuizCategory[] = [
  {
    name: "Data Analysis with Pandas",
    description: "TODO: Add description for Data Analysis with Pandas",
    color: "#3b74dd", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 18,
  },
];

export const pandasAnalysisQuestions: QuizQuestion[] = [
  // TODO: Add questions for Data Analysis with Pandas
  {
