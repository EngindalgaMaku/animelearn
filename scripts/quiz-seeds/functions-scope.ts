...
export const functionsScopeCategories: QuizCategory[] = [
  {
    name: "Functions and Scope",
    description: "TODO: Add description for Functions and Scope",
    color: "#893318", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 4,
  },
];

export const functionsScopeQuestions: QuizQuestion[] = [
  // TODO: Add questions for Functions and Scope
  {
