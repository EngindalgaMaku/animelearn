...
export const oopAdvancedCategories: QuizCategory[] = [
  {
    name: "Object-Oriented Programming - Advanced",
    description: "TODO: Add description for Object-Oriented Programming - Advanced",
    color: "#042052", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 12,
  },
];

export const oopAdvancedQuestions: QuizQuestion[] = [
  // TODO: Add questions for Object-Oriented Programming - Advanced
  {
