...
export const advancedDataStructuresCategories: QuizCategory[] = [
  {
    name: "Advanced Data Structures",
    description: "TODO: Add description for Advanced Data Structures",
    color: "#7049ae", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 9,
  },
];

export const advancedDataStructuresQuestions: QuizQuestion[] = [
  // TODO: Add questions for Advanced Data Structures
  {
