...
export const apisWebScrapingCategories: QuizCategory[] = [
  {
    name: "APIs & Web Scraping",
    description: "TODO: Add description for APIs & Web Scraping",
    color: "#e6797d", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 17,
  },
];

export const apisWebScrapingQuestions: QuizQuestion[] = [
  // TODO: Add questions for APIs & Web Scraping
  {
