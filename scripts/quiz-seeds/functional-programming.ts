...
export const functionalProgrammingCategories: QuizCategory[] = [
  {
    name: "Functional Programming Tools",
    description: "TODO: Add description for Functional Programming Tools",
    color: "#5c691e", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 10,
  },
];

export const functionalProgrammingQuestions: QuizQuestion[] = [
  // TODO: Add questions for Functional Programming Tools
  {
