...
export const webFrameworksCategories: QuizCategory[] = [
  {
    name: "Web Frameworks (Flask & Django)",
    description: "TODO: Add description for Web Frameworks (Flask & Django)",
    color: "#762cbb", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 16,
  },
];

export const webFrameworksQuestions: QuizQuestion[] = [
  // TODO: Add questions for Web Frameworks (Flask & Django)
  {
