...
export const generatorsDecoratorsCategories: QuizCategory[] = [
  {
    name: "Generators & Decorators",
    description: "TODO: Add description for Generators & Decorators",
    color: "#d87595", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 11,
  },
];

export const generatorsDecoratorsQuestions: QuizQuestion[] = [
  // TODO: Add questions for Generators & Decorators
  {
