...
export const errorHandlingCategories: QuizCategory[] = [
  {
    name: "Error & Exception Handling",
    description: "TODO: Add description for Error & Exception Handling",
    color: "#926798", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 7,
  },
];

export const errorHandlingQuestions: QuizQuestion[] = [
  // TODO: Add questions for Error & Exception Handling
  {
