...
export const systemAutomationCategories: QuizCategory[] = [
  {
    name: "System Automation & Scripting",
    description: "TODO: Add description for System Automation & Scripting",
    color: "#d2fe23", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 22,
  },
];

export const systemAutomationQuestions: QuizQuestion[] = [
  // TODO: Add questions for System Automation & Scripting
  {
