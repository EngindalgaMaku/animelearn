...
export const numpyComputingCategories: QuizCategory[] = [
  {
    name: "Numerical Computing with NumPy",
    description: "TODO: Add description for Numerical Computing with NumPy",
    color: "#be3b8e", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 19,
  },
];

export const numpyComputingQuestions: QuizQuestion[] = [
  // TODO: Add questions for Numerical Computing with NumPy
  {
