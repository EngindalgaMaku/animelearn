...
export const fileHandlingCategories: QuizCategory[] = [
  {
    name: "File Handling & Serialization",
    description: "TODO: Add description for File Handling & Serialization",
    color: "#714ff6", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 6,
  },
];

export const fileHandlingQuestions: QuizQuestion[] = [
  // TODO: Add questions for File Handling & Serialization
  {
