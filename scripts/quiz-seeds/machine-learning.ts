...
export const machineLearningCategories: QuizCategory[] = [
  {
    name: "Machine Learning with Scikit-Learn",
    description: "TODO: Add description for Machine Learning with Scikit-Learn",
    color: "#44ea5b", // Random color
    icon: "📚", // TODO: Choose appropriate icon
    sortOrder: 21,
  },
];

export const machineLearningQuestions: QuizQuestion[] = [
  // TODO: Add questions for Machine Learning with Scikit-Learn
  {
